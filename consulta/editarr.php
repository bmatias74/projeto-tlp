  ...
  <form class="formulario" id="formulario" action="adm.php?menuop=atualizarr" enctype="multipart/form-data" method="post">
    ...
    <div class="inputg">
      ...
      <div>
        ...
        <input type="email" placeholder="Insira o email" name="Email" id="email" value="<?= $linha["email"] ?>">
      </div>
      ...
      <div class="radios">
        ...
        <div>
          ...
          <input type="text" id="descricao" name="descricao" value="<?= $linha["descricao"] ?>" placeholder="Digite uma descrição acerca do restaurante">
        </div>
        <!-- Localização-->
        <div>
        ...
        <div>
          ...
          <input type="text" placeholder="Se tiver insira o site da empresa" name="site" id="site" value="<?= $linha["siter"] ?>">
        </div>
      </div>
      <div class="radios">
        <div class="radio">
